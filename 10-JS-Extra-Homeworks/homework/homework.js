...
function numberOfCharacters (string) {
  ...
  // Escribe tu código aquí
  const nuevoObjeto = {}
  const cadenaTransform = string.split('').sort()
  for (let i = 0; i < cadenaTransform.length; i++) {
...
function asAmirror (str) {
  ...
  // Escribe tu código aquí
  const otraCadena = str.split(' ')
  const nuevoArray = []
  for (let i = 0; i < otraCadena.length; i++) {
...
function sortArray (arr) {
  ...
  const nuevaCadena = arr.sort(function (a, b) {
...
function buscoInterseccion (arreglo1, arreglo2) {
  ...
  // Escribe tu código aquí
  const numeros = arreglo1.concat(arreglo2)
